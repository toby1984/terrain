            ...
            for ( int x = 0 ; x < size-2 ; x++, ptr++)
            {
                ...
                switch(index)
                {
                    ...
                    case 1:
                        ...
                        p0.set(x0,height,y0);
                        p1.set(x0+squareSize/2f,height,y0);
                        p2.set(x0,height,y0+squareSize/2f);
                    ...
                    case 2:
                        ...
                        p0.set(x0+squareSize/2f,height,y0);
                        p1.set(x0+squareSize,height,y0);
                        p2.set(x0+squareSize,height,y0+squareSize/2f);
                    ...
                    case 3:
                        ...
                        p1.set(x0+squareSize,height,y0);
                        p2.set(x0+squareSize,height,y0+squareSize/2f);
                        p3.set(x0,height,y0+squareSize/2f);
                    ...
                    case 4:
                        ...
                        p0.set(x0+squareSize/2f,height,y0+squareSize);
                        p1.set(x0+squareSize,height,y0+squareSize/2f);
                        p2.set(x0+squareSize,height,y0+squareSize);
                    ...
                    case 5:
                        ...
                        p0.set(x0+squareSize/2f,height2,y0+squareSize);
                        p1.set(x0+squareSize,height2,y0+squareSize/2f);
                        p2.set(x0+squareSize,height2,y0+squareSize);
                    ...
                    case 6:
                        ...
                        p1.set(x0+squareSize,height,y0);
                        p2.set(x0+squareSize,height,y0+squareSize);
                        p3.set(x0+squareSize/2f,height,y0+squareSize);
                    ...
                    case 8:
                        ...
                        p0.set(x0,height,y0+squareSize/2f);
                        p1.set(x0+squareSize/2f,height,y0+squareSize);
                        p2.set(x0,height,y0+squareSize);
                    ...
                    case 9:
                        ...
                        p0.set(x0,height,y0);
                        p1.set(x0+squareSize/2f,height,y0);
                        p2.set(x0+squareSize/2f,height,y0+squareSize);
                        p3.set(x0,height,y0+squareSize);
                    ...
                    case 13:
                        height = TriangleList.HEIGHT_SCALE_FACTOR*(data.water.get(ptr)+data.height.get(ptr));
                        p0.set(x0,height,y0);
                        p1.set(x0+squareSize,height,y0+squareSize);
                        p2.set(x0,height,y0+squareSize);
                    ...
                    case 14:
                        height = TriangleList.HEIGHT_SCALE_FACTOR*(data.water.get(ptr+1)+data.height.get(ptr+1));
                        p0.set(x0+squareSize,height,y0);
                        p1.set(x0+squareSize,height,y0+squareSize);
                        p2.set(x0,height,y0+squareSize);
